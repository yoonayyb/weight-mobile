...
<!--    <info-template title="小程序权限设置" :icon="true" @click="openSetting"></info-template>
    <info-template title="消息推送提醒" :icon="true" @click="openSetting"></info-template> -->
    <info-template title="订单提醒" :icon="true" @tap="orderRequestSubscribeMessage"> </info-template>
  ...
  methods: {
    ...
    handleLogout() {
      this.$common
        ...
        .then((res) => {
          if (this.$store.state.user.isTongji) {

<template>
	<view class="number_keyboard" :v-if="show" @touchmove.stop.prevent="clear" :style="{ zIndex: zIndex ,background:bg,padding:padding}">
		...
		<view class="number_keyboard_container" :style="{ zIndex: zIndex + 2, bottom: bottom + 'px' }"
			...
			<view class="number_keyboard_content" :style="{background:bg}">
				<view class="number_keyboard_item" @click="handleClickKeyboard(item)"

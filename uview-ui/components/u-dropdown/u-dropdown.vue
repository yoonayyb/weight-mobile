  ...
  <view class="u-dropdown">
    ...
    >
      <view class="u-dropdown__menu__item" v-for="(item, index) in menuList" :key="index" @tap.stop="menuClick(index)">
        <view class="u-flex">
			<input type="text" v-if="textInput"  class="u-dropdown__menu__item__text"
			:placeholder="placeholder"
			@focus="placeholder = ''"
			@blur="placeholder = '请输入'"
...
export default {
  ...
  watch:{
	  length(val){
		  ...
		  this.itemHeight = this.height * this.length
		  this.$emit('itemHeight', this.itemHeight)
	  }
  },
  created() {
  ...
  methods: {
	  ...
	  input(val){
		  ...
		  this.inputTitle = val.detail.value
		this.$emit('input',{classname:this.classname,val})
	  },
    init() {
    ...
    close() {
	  ...
	  console.log('this.menuList[index]',this.menuList[this.current])
	  this.children.map((child) => {
	   child.setTitle()
	  })
    ...
    getContentHeight() {
      ...
      this.$uGetRect('.u-dropdown__menu').then((res) => {
        ...
        console.log('this.$u.sys().windowHeight', this.$u.sys().windowHeight)
